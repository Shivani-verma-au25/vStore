...
function Navbar() {
  ...
  if (loading) return ( <div className='w-screen h-screen flex justify-center items-center'>
    <Loader className='size-20 animate-spin transition-all duration-150' /><span className="text-2xl font-semibold">Loading...</span>
    </div> )
  ...
  return (
    <nav className="w-full max-w-7xl mx-auto py-5 lg:px-10 px-5 flex justify-between items-center  bg-white">
      ...
      <div className="hidden lg:flex items-center ">
        ...
        <Link to={'/cart'} className=" border border-green-600 ml-15 size-10 flex justify-center items-center " ><ShoppingCart className=" cursor-pointer hover:text-green-600" /></Link>
      </div>
